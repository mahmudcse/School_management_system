...
class Login extends CI_Controller {
    ...
    function validate_login($email = '', $password = '') {
        ...
        $credentialstudent = array('student_code' => $email, 'password' => $password);
        $credentialparent = array('phone' => $email, 'password' => $password);
        ...
        $query = $this->db->get_where('student', $credentialstudent);
        if ($query->num_rows() > 0) {
            $row = $query->row();
        ...
        $query = $this->db->get_where('parent', $credentialparent);
        if ($query->num_rows() > 0) {
            $row = $query->row();
