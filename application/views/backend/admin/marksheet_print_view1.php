...
<div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;margin-top:0px; margin-bottom:0px;" align="left">
    <table style="width:100%;font-size:11px;">
        <tr>
            <td width="18%"> <strong>Student Name</strong></td>
            <td width="1%"> : </td>
            <td width="56%"><?php echo $student['name'];?></td>
            <td width="9%"><strong>Class</strong></td>
            <td width="1%"> : </td>
            <td width="15%"> <?php echo $class['name'];?> </td>
        </tr>
        <tr>
            <td width="18%"><strong>Father's Name</strong></td>
            <td width="1%"> : </td>
            <td width="56%"><?php echo $student['fathername'];?></td>
            <td width="9%"><strong>Section</strong> </td>
            <td width="1%"> : </td>
            <td width="15%"><?php echo $section_name;?></td>
        </tr>
        <tr>
            <td width="18%"><strong>Session</strong></td>
            <td width="1%"> : </td>
            <td width="56%"><?php echo $session_start;?>-<?php echo $session_end;?></td>
            <td width="9%"><strong>Roll No</strong> </td>
            <td width="1%"> : </td>
            <td width="15%"><?php echo $student_roll;?></td>
        </tr>
    </table>                            
</div>
...
?>
    <div class="accordion-group">
        ...
        <div id="collapse<?php echo $exm['exam_id'];?>" class="accordion-body collapse <?php if($toggle){echo 'in';$toggle=false;}?>" >
            <div class="accordion-inner">
                <table border="1" style="width:100%; font-size:10px;border-collapse:collapse; border:1px solid #CCCCCC; text-align:center; margin:15px 0px 20px 0px"> 
                    <thead>
                        <tr bgcolor="#F3F3F3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <strong><?php
                                    echo round($total_marks*100/$total_examMark , 2);?></strong>    
                            </td>   
    ...
    <div style="border:1px solid #F3F3F3;padding:20px; margin-top:10px;">
        A+ [80-100] , A - Very Good, B - Good , C - Satisfactory , D - Needs  Improvement , E - Unclassified </div>
