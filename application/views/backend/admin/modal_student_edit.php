...
$edit_data		=	$this->db->get_where('enroll' , array(
	'student_id' => $param2 , 'session_id' => $this->db->get_where('settings' , array('type' => 'running_year'))->row()->description
))->result_array();
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body" style="background-color:#F8F8F8">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/do_update/'.$row['student_id'].'/'.$row['class_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Student Code');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" name="student_code"  data-message-required="<?php echo get_phrase('value_required');?>" 
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Father&rsquo;s Name');?></label>
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="fathername" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->fathername; ?>">
						</div>
					</div>
					
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Father&rsquo;s Profession');?></label>
                        
						<div class="col-sm-5">
							<select name="fprofession" class="form-control selectboxit">
							<?php
								$gender = $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->fprofession;
							?>
                              <option value=""><?php echo get_phrase('select');?></option>
                              <option value="Service" <?php if($gender == 'Service')echo 'selected';?>><?php echo get_phrase('Service');?></option>
                              <option value="Business"<?php if($gender == 'Business')echo 'selected';?>><?php echo get_phrase('Business');?></option>
                          </select>
						</div> 
					</div>
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Mobile(F)');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" name="fcontactno" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->fcontactno; ?>">
						</div>
					</div>
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Mother&rsquo;s Name');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" name="mothername" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->mothername; ?>">
						</div>
					</div>
					
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('Mother&rsquo;s Profession');?></label>
                        
						<div class="col-sm-5">
							<select name="mprofession" class="form-control selectboxit">
							<?php
								$gender = $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->mprofession;
							?>
                              <option value=""><?php echo get_phrase('select');?></option>
                              <option value="Service" <?php if($gender == 'Service')echo 'selected';?>><?php echo get_phrase('Service');?></option>
                              <option value="Business"<?php if($gender == 'Business')echo 'selected';?>><?php echo get_phrase('Business');?></option>
                              <option value="Housewife"<?php if($gender == 'Housewife')echo 'selected';?>><?php echo get_phrase('Housewife');?></option>
                          </select>
						</div> 
					</div>
					
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Mobile(M)');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control" name="mcontactno"  data-message-required="<?php echo get_phrase('value_required');?>" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->mcontactno; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="paddress" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->paddress; ?>" >
						</div> 
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="password" class="form-control" name="password"  
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->password; ?>">
						</div>
					</div>
					<input type="hidden" class="form-control" name="password_old"  
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->password; ?>">
