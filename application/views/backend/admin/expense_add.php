	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/expense/create/' , array('class' => 'form-inline form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
	

					<div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('account');?></label>
                        <div class="col-sm-6">
                            <select name="account" class="form-control selectboxit" required>
					...
					<div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('item');?></label>
                        <div class="col-sm-6">
                            <select name="item" class="form-control selectboxit" required>
