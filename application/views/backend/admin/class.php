                ...
                <table class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                    		...
                    		<th><div><?php echo get_phrase('campus');?></div></th>
                    		<th><div><?php echo get_phrase('options');?></div></th>
						</tr>
					</thead>
                    <tbody>
                    	<?php $count = 1;foreach($classinfo as $row):
                    	?>
                        <tr>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
	                        <div class="padded">
								...
								<div class="col-sm-5">
								<select name="campus" class="form-control selectboxit">
								  <option value="">Select Campus</option>
	                              <?php foreach ($campuslist as $campus):?>	                                                         
	                              <option value="<?php echo $campus['id']?>" <?php if($campus['id'] == $default_campus) echo "selected"; ?>><?php echo $campus['campus_name'];?></option>
	                              <?php endforeach ?>
	                            </select>
								</div> 
							</div>
