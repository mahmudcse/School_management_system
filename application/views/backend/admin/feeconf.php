             ...
             <?php echo form_open(base_url() . 'index.php?admin/feeconf/filter' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
	             ...
	             <div class="form-group">
                  ...
                  <div id="group_select" class="form-group">
                      <label  class="col-sm-3 col-sm-offset-5 control-label"><?php echo $groupClass[1][value];?></label>
                     
                      <div class="col-sm-offset-0 col-sm-3">
                          <select name="group_id" class="form-control selectboxit" onchange="this.form.submit();">
                            <option value="-1">Select</option>
                          <?php foreach ($grouplist as $grps):?>
                              <option <?php 
                              $common_id = $this->db->get_where('class_group', array('group_name' => 'Common'))->row()->id;
                              if($group_id == $grps['id']){ echo "selected=\"selected\"";}elseif($grps['id'] == $common_id){ echo "disabled";}?> value="<?php echo $grps['id'];?>"><?php echo $grps['group_name'];?> </option>
                          <?php endforeach;?>
                          </select>
                      </div>
                  </div>
	             ...
	             <table class="table table-bordered">
	                	<thead>
	                     ...
	                     <tbody>
	                        ...
	                        <tr>
	                            <td>
                                <input type="hidden" name="fee_<?php echo $cnt?>" value="<?php echo $fee['componentId'];?>"/> <?php echo $fee['itemName'];?>
                              </td>

								              <td>
                                <input name="amount_<?php echo $cnt?>" type="text" value="<?php echo $amt;?>" />
                              </td>
