			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/manage_campus/create' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" readonly="readonly" class="form-control" name="institute_name" value="<?php echo $institute?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" 
                            	value="">
						</div>
					</div>              
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('add_campus');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
