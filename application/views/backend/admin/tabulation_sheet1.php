		...
		<?php echo form_open(base_url() . 'index.php?admin/tabulation_sheet');?>
			...
			<div class="col-md-4">
				...
				<label class="control-label"><?php echo get_phrase('exam');?></label>
					<?php echo form_dropdown('exam_id', $terms, $termId,"class=\"form-control selectboxit\"");?>
				</div>
			</div>
	...
	<div class="col-md-12">
		<table class="table table-bordered">
			<thead>
				...
				<?php 
					$subjects = $this->db->get_where('course' , array('class_id' => $class_id , 'session_id' => $running_year))->result_array();
