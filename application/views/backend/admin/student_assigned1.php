        ...
        <br>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/course_student' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                 ...
                 <div class="padded" style="padding-top:20px">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-5">
									...
									<?php echo form_dropdown('studentId', $allstudents, $studentId, "class=\"form-control selectboxit\"");?>
                                </div>
                            </div>
							 <div class="form-group">
