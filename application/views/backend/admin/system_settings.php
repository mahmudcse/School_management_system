        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="system_email" 
                              value="<?php echo $settings['system_email'];?>">
                      </div>
                  </div>

                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('default_campus');?></label>
                      <div class="col-sm-9">
                          <select name="default_campus" class="form-control selectboxit">
                            <option value="">No defult Campus</option>
                          <?php foreach ($campuses as $campus):?>
                              <option <?php if($settings['default_campus'] == $campus['id']){ echo "selected=\"selected\"";}?> value="<?php echo $campus['id'];?>"><?php echo $campus['campus_name'];?> </option>
                          <?php endforeach;?>
                          </select>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          ...
                          <?php foreach ($sessions as $ses):?>
                              <option <?php if($settings['running_year'] == $ses['componentId']){ echo "selected=\"selected\"";}?> value="<?php echo $ses['componentId'];?>"><?php echo $ses['uniqueCode'].'('.$ses['start'].'-'.$ses['end'].')';?> </option>
                          <?php endforeach;?>
                          </select>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('running_term');?></label>
                      <div class="col-sm-9">
                          <select name="running_term" class="form-control selectboxit">
                          <?php foreach ($terms as $term):?>
                              <option <?php if($settings['running_term'] == $term['exam_id']){ echo "selected=\"selected\"";}?> value="<?php echo $term['exam_id'];?>"><?php echo $term['name'];?> </option>
                          <?php endforeach;?>
                          </select>
                      </div>
                  </div>
