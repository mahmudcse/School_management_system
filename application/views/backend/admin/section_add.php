			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/sections/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="class_id" id="class" class="form-control selectboxit" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="group_id" id="class" class="form-control selectboxit" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                              
                              <?php 
									$groups = $this->db->get('class_group')->result_array();
									foreach($groups as $row):
										?>
                                		<option value="<?php echo $row['id'];?>" <?php if($row['group_name'] == 'Common') echo 'selected'?>>
