...
<div class="row">
	<div class="col-md-12">
		<?php echo form_open(base_url() . 'index.php?'.$account_type.'/examtype_marks');?>
			<div class="col-md-3">
			...
			<div class="col-md-2">
				<div class="form-group">
					...
					<?php echo form_dropdown('groupId',$allgroups, $groupId, "class='selectboxit'"); ?>
				</div>
			</div>
			<div class="col-md-2">
				<div class="form-group">
			...
			<div class="col-md-2">
				<div class="form-group">
				<label class="control-label"><?php echo get_phrase('examtype');?></label>
				<?php echo form_dropdown('examtypeId', $examtypess, $examtypeId, "onchange=\"this.form.submit();\" class=\"form-control selectboxit\"");?>
