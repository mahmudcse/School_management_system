                    ...
                    <tbody>
                        <?php 
                            ...
                            <tr>
                                    ...
                                    <?php
                                        ...
                                        <?php
                                            ...
                                            <?php 
                                                    ...
                                                    <a href="<?php echo base_url(); ?>index.php?admin/attendance_report/<?php echo $select_time; ?>/<?php echo $group_id; ?>/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $course_id; ?>/absent_sms"
                                ...
                                <td>
                                    <a href="<?php echo base_url(); ?>index.php?admin/manage_attendance_view/<?php echo $group_id; ?>/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $course_id; ?>/<?php echo $select_time; ?>" 
