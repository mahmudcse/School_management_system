		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body" style="background-color:#F8F8F8">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<!-- <div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="student_code" data-message-required="<?php //echo get_phrase('value_required');?>" value="" autofocus>
						</div>
					</div> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="fcontactno" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="mcontactno"  data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus>
						</div>
					</div>
				<!--
					<div class="form-group">
					...
					-->
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('campus');?></label>
                        
						<div class="col-sm-5">
							<select name="campus" class="form-control selectboxit" required onchange="get_campus_class(this.value);" id="campus">
                              <option value=""><?php echo get_phrase('select');?></option>
                              <?php 
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="class_id" class="form-control" id="campus_class_holder" data-validate="required" 
								data-message-required="<?php echo get_phrase('value_required');?>"
									onchange="get_class_group(this.value); ">
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo $groupClass[1]['value']; ?></label>
                        
						<div class="col-sm-5">
							<select name="group_id" class="form-control" id="group_selector_holder"  data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"
										onchange="get_group_sections(this.value)">                     
                          </select>
						</div> 
					</div>
		    ...
		    <select name="section_id" class="form-control" id="section_selector_holder" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" data-format="dd-MM-yyyy" class="form-control datepicker" name="birthday" value="" data-start-view="2">
						</div> 
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<textarea name="address" id="ttt" rows="3" class="form-control"></textarea>
						</div> 
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<textarea name="paddress" id="ttt" rows="3" class="form-control"></textarea>
						</div> 
					</div>
...
$(window).load(function(){
	...
	$.ajax({
        ...
        {				
            jQuery('#campus_class_holder').html(response);
        }
    });
	...
	function get_group_sections(group_id) {
		class_id = $("#campus_class_holder").val();
    	$.ajax({
            url: '<?php echo base_url();?>index.php?admin/get_group_sections/' + group_id + '/' + class_id ,
            success: function(response)
            {				
	...
	function get_class_group(class_id) {
    	$.ajax({
            url: '<?php echo base_url();?>index.php?admin/get_class_group' ,
            success: function(response){
            	$("#group_selector_holder").html(response);
            	}	
            });
