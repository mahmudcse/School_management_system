...
<img src="<?php echo base_url('uploads/logo.png'); ?>" width="90" height="80">
...
<div id="gradeTable" hidden>
    <table style="width: 15%; font-size: 9px;>
        <caption style="text-align: center;">Grading System</caption>
        <tr>
            <td>Mark Range</td>
            <td>Letter Grade</td>
            <td>Grade Point</td>
        ...
        <?php foreach ($grades as $key => $grade): ?>
            ...
            <div class="col-md-5" id="grades" hidden>
                <table class="table table-bordered" style="width:70%; height: 50%; font-size: 10px; padding: 1px;">
                    <thead>
                        <tr>
