			...
			<div id="session_static">			
			   ...
			   <li>
	           		<h4>
	           			...
	           			<?php endif;?>>
	           				<?php echo get_phrase('running_session');?> : <?php 							
							$current_session_name = $this->db->get_where('session', array('componentId'=>$running_year))->result_array();
							foreach ($current_session_name as $row):							
							echo $row['start']." to ".$row['end'];
							endforeach;
							?>
	           			</a>
	           		</h4>
