...
<div class="mail-env">
    ...
    <div class="mail-sidebar" style="min-height: 800px;">
        ...
        <div class="mail-sidebar-row hidden-xs">
            <a href="<?php echo base_url(); ?>index.php?<?php if($account_type=='parent') echo $account_type.s; else echo $account_type;?>/message/message_new" class="btn btn-success btn-icon btn-block">
...
//                         exit();
            foreach ($message_threads as $row):
                ...
                <li class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code']) echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?<?php  if($account_type == 'parent'){echo $account_type.'s';} else echo $account_type;?>/message/message_read/<?php echo $row['message_thread_code']; ?>" style="padding:12px;">
