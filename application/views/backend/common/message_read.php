...
<?php if($account_type == 'parent') {$account_type = $account_type.'s';} echo form_open(base_url() . 'index.php?'.$account_type.'/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
