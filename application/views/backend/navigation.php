<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
		...
		<?php foreach ($menu as $item):?>
		 <li class="<?php if ($page_name == $item['function']) echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/<?php echo $item['function'];?>">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase($item['display_name']); ?></span>
            </a>
        </li>
		<?php endforeach;?>
        ...
        <li class="<?php
        if ($page_name == 'Campus' ||
                $page_name == 'add_campus' ||
                    $page_name == 'manage_campus')
                        echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-flow-tree"></i>
                <span><?php echo get_phrase('campus'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'add_campus') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/add_campus">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('add_campus'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'manage_campus') echo 'active'; ?> ">
