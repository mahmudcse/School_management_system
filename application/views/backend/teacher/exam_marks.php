				...
				<tbody>	
	            	...
	            	<tr>
	            		...
	            		<td><?php echo $student['name'];?></td>
	            			<?php foreach($examtypes as $examtype): ?>
	            		<td>
	            			<input class="datacell" id="<?php echo $examtype['examtype_id'].'/'.$student['student_id'];?>" style="width: 80px;" value="<?php echo $marks[$termId][$courseId][$examtype['examtype_id']][$student['student_id']];?>"/>
	            		</td>
	            		<?php endforeach;?>
	            	</tr>
	            	<?php endforeach;?>
