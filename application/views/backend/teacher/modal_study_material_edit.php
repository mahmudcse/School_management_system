...
$single_study_material_info = $this->db->get_where('document', array('documentId' => $param2))->result_array();
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?teacher/study_material/update/<?php echo $row['documentId'] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="field-ta" class="col-sm-3 control-label"><?php echo get_phrase('group'); ?></label>

                            <div class="col-sm-5">
                                <select name="group" class="form-control selectboxit">
                                    
                                    <?php foreach ($groups as $row2) { ?>
                                        <option value="<?php echo $row2['id']; ?>" <?php if ($row['group_id'] == $row2['id']) echo 'selected'; ?>>
