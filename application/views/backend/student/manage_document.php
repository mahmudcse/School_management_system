		...
		<div class="tab-content">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                                ...
                                -->
                                <a href="<?php echo base_url();?>index.php?teacher/downloadDocument/<?php echo $document['documentId'];?>" class="btn btn-red btn-small">
                                	<i class="icon-download"></i> <?php echo get_phrase('download');?>
                                </a>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open_multipart('teacher/document/upload' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                        <div class="padded">
