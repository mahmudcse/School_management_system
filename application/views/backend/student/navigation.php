<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- ACADEDIC CALENDAR -->
		<li
			class="<?php if ($page_name == 'view_academic_calendar') echo 'active'; ?> ">
			<a href="<?php echo base_url(); ?>index.php?student/academic_calendar">
        ...
        <!-- NOTICEBOARD -->
        <li class="<?php if ($page_name == 'view_noticeboard') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/view_noticeboard">
