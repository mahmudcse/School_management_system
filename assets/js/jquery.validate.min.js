		...
		rules : function(e, i) {
			...
			if (e) {
				...
				case "add":
					...
					delete a.messages
					, n[s.name] = a, i.messages && (r.messages[s.name] = t.extend(r.messages[s.name], i.messages));
					break;case "remove":
		...
		prototype : {
			...
			element : function(e) {
				...
				return i ?
						...
						: this.invalid[e.name] = !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), i
			},
			...
			stopRequest : function(e, i) {
				this.pendingRequest--, 0 > this.pendingRequest && (this.pendingRequest = 0),
				...
				return a[i.name] = e, t.ajax(t.extend(!0, {
						...
						success : function(s) {
							...
							if (a) {
								...
								n.prepareElement(i), n.formSubmitted = u, n.successList.push(i),
